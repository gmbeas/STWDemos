...
namespace ServicioHoraPI.Clases
{
    ...
    public class SNTPClient
    {
        ...
        public void Connect(bool UpdateSystemTime)
        {
            try
            {
                ...
                if (!IsResponseValid())
                {
                    Log.WriteErrorLog("Invalid response from " + _timeServer);
            ...
            catch (SocketException e)
            {
                ...
                //Console.ReadLine();
                Log.WriteErrorLog("ERROR 1: " + e.ToString());
            }
        ...
        private void SetTime()
        {
            ...
            {
                Log.WriteErrorLog("ERROR 2: " + e.ToString());
